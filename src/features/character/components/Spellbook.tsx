        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex items-center justify-around gap-4">
                <label className="flex items-center gap-2 cursor-pointer text-sm">
                    <input type="checkbox" checked={formData.ritual} onChange={() => handleCheckboxChange('ritual')} className="form-checkbox bg-input border-border text-primary focus:ring-primary" />
                    Ritual
                </label>
                <label className="flex items-center gap-2 cursor-pointer text-sm">
                    <input type="checkbox" checked={formData.concentration} onChange={() => handleCheckboxChange('concentration')} className="form-checkbox bg-input border-border text-primary focus:ring-primary" />
                    Concentration
                </label>
            </div>
        </div>
